...
try:
    release = pkg_resources.get_distribution('groundwork_validation').version
except pkg_resources.DistributionNotFound:
    print('groundwork-validation must be installed to build the documentation.')
...
html_theme_options = {
    "contribute": True,
    "github_fork": "useblocks/groundwork-validation",
...
#
# html_title = 'groundwork-validation v0.1'
...
# of the sidebar.
#
html_logo = "/_static/gw_validation_logo.png"
...
htmlhelp_basename = 'groundwork-validationdocs'
...
latex_documents = [
    (master_doc, 'groundwork-validation.tex', 'groundwork-validation Documentation',
...
man_pages = [
    (master_doc, 'groundwork-validation', 'groundwork-validation Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'groundwork-validation', 'groundwork-validation Documentation',
     author, 'groundwork-validation', 'One line description of project.',
     'Miscellaneous'),
]
